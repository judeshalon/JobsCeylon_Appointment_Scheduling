...
<html lang="en">
    <head>
        ...
        <title>Admin DashBoard | Appointment Rescheduling Page</title>
        <link rel="stylesheet" 
    ...
    <body>
        ...
        <div class="custom-container">
            <div class="login-box">
                Rescheduling an Appointment Account
            </div>
        </div>
        ...
        <div class="container form-container">
            ...
            <form id="createAppointment" action="RescheduleAppointmentServlet" method="post" >
