...
<html>
    <head>
        ...
        <title>Jobs Ceylon - Job Seeker </title>
        <style>
            /* Global Styles */
            body {
    ...
    <body>
        <header>
            <h1>Welcome to The Jobs Ceylon - Job Seeker</h1>
        </header>
        <div class="flex-container reverse">
            ...
            <section class="section" id="consultant-details">
                ...
                <div class="flex-container">
                    <div class="user-table">
                        <button id="add-consultant-btn"  class="button-container">Add Consultant</button>
                        <br> <br>
                        <table class="table">
                            <thead>
                                <tr>
