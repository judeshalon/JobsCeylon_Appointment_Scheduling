...
<html lang="en">
    <head>
        ...
        <title>Job Seeker DashBoard | Edit Appointment</title>
    ...
    <body>
        ...
        <div class="navbar">
            <a href="jobseekerdashboard.jsp">Go to Job Seeker Dashboard</a>
        ...
        <div class="form-container" >
            <form class="row g-3 ">
                <div class="col-md-6 field-container" action="JobseekerAppointmentRescheduleServlet" method="post">
