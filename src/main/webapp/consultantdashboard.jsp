...
<html>
    <head>
        ...
        <title>Jobs Ceylon - Consultant Dashboard </title>
        <style>
            /* Global Styles */
            body {
    ...
    <body>
        <header>
            <%
                Consultant consultant = (Consultant) session.getAttribute("userObj");

            %>
            <h1>Welcome to The Jobs Ceylon - Consultant - <%=consultant.getFname() + ' ' + consultant.getLname()%></h1>
        </header>
                    ...
                    <div class="user-table">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><%= consultant.getFname()%></td>
                                    <td><%= consultant.getLname()%></td>
                                    <td><%= consultant.getEmail()%></td>
                                    <td><%= consultant.getPassword()%></td>
                                    <td><%= consultant.getPhoneNumber()%></td>
                                    <td><%= consultant.getSpecializedCountries()%></td>
                                    <td><%= consultant.getWorkingPeriod()%></td>

                                    <td>
                                        <a href="consultantEdit.jsp?id=<%= consultant.getId()%>"
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <%
                                    ...
                                    List<Appointment> appointmentList = dao.getAppointmentByConsultantId(consultant.getId());
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="rescheduleAppoinment.jsp?id=<%= appointment.getId()%>"
